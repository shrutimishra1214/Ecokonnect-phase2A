...
.global__loading span.global__loading__inner{
    ...
    background: linear-gradient(to right top, #122f5c, #004f7b, #006f8d, #008e90, #29ab87);
...
.ecokonnect--greeting .primary__btn{
    padding: 5px 10px;
    width: 90%;
    margin: 10px auto 0 auto;
    font-size: 15px;
}
.ecokonnect--greeting .empty--card .plus--icon--container svg{
    margin:0;
}
