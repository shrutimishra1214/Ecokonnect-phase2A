...
import slide1 from "../../Assets/Login-Slides/slide2.0.jpg";
import slide2 from "../../Assets/Login-Slides/slide2.1.jpg";
import slide3 from "../../Assets/Login-Slides/slide2.2.jpg";
import slide4 from "../../Assets/Login-Slides/slide.jpg";
import slide5 from "../../Assets/Login-Slides/slide.jpg";
// ------x----------Import slides-------x--------
                                                ...
                                                db.collection(Consts.USERS)
                                                  ...
                                                  .then(() => {
                                                    if(_isMounted?.current){
                                                      ...
                                                      timeouts.current = setTimeout(() => {
                                                        notify(
                                                          "Welcome to Ecokonnect. Start by adding posts to your account."
                                                        );
                                                        setLoading(false);
                                                        props.history.push("/");
                                                      }, 150);
                    ...
                    .then(() => {
                      if(_isMounted?.current){
                        timeouts.current = setTimeout(() => {
                          ...
                          context.notify(
                            `Welcome to Ecokonnect${given_name && ", " +given_name}. Start by adding posts to your account.`
                          );
                          props.history.push("/");
                        }, 150);
                      }
                    ...
                    .then(() => {
                      if(_isMounted?.current){
                        timeouts.current = setTimeout(() => {
                          ...
                          context.updatedReceivedData();
                          context.notify(
                            `Welcome to Ecokonnect${name && ", " +name}. Start by adding posts to your account.`
                          );
                          props.history.push("/");
                        }, 150);
                      }
            ...
            <div className="auth flex-column mt-5">
              <div className="auth--upper--card w-100 flex-column">
                <div className="auth--logo flex-row">
                  <h1 className="logoText">EcoKonnect</h1>
                </div>
                <small className="insta--warning">
                  Here's the beginning to your sustainable life
                </small>
                  ...
                  !signUpState ? (
                    ...
                    >
                      ...
                      <div className="signIn--options--box">
                       {/* <SignInOption
                       //   method="anonymous"
                       //   methTitle="Log in without credentials just to experiment with the app. However, you may not get all the features Ecokonnect offers. Also, all your information will be public."
                    ...
                    <div>
                      ...
                      >
                        ...
                        {/*<ReCAPTCHA
                            ...
                            onErrored={(() => onRecapChange(true))}
                            onExpired={(() => onRecapChange(true))}
                        />*/}
