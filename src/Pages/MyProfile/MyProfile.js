                ...
                </div>
                {
                 ...
                 (receivedData?.posts?.length >=1 && !loading ?
                    <div >
                        ...
                        :
                        (
                            <div className="my-empty--posts--container">
                                <div className="my-empty--posts--img">
                                </div>
                                <div className="my-empty--posts--text--container">
                                    <h2>Start capturing and sharing your thoughts.</h2>
