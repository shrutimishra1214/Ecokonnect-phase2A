    ...
    <Auxiliary>
      ...
      <header ref={headerRef} id="header" className="main--header flex-row">
        <div className="header--inner flex-row">
          <div title="EcoKonnect" className="header--logo--box flex-row">
            <div style={{
            ...
            <ul className="header--ul flex-row">
              <li title="Home">
                <NavLink
                  ...
                  tabIndex="0"
                >
                  <ImHome style={{ fontSize: "26px" }} aria-label="Home"/>
                </NavLink>
              </li>
              {user ? (
                <>
                      ...
                      <div className="noti--popup--inner">
                        ...
                        <ul className="prof--popup--ul flex-column">
                          <Link onClick={() => setProf(false)} to="/profile">
                            ...
                            <li>
                              <span className="prof--item--inner flex-row" >
                                <CgCalculator className="prof__popup" /> <a href="https://confident-goldstine-04cf4b.netlify.app/index.html">CFG Calculator</a>
                              </span>
                            </li>
